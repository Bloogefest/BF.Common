...
/**
 * Строгое исключение, предназначенное для применения в некритических ситуациях, требующих немедленного реагирования.
 * Например, когда происходит неожиданное закрытие файлового потока. Это исключение расширяет
 * {@linkplain Exception базовое исключение}.
 *
 * @since 3.0.0-RC1
 */
