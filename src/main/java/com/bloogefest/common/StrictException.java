...
public class StrictException extends Exception {
    ...
    @Removal("4.0.0-RC4")
    @Obsolete("com.bloogefest.common.StrictException.DEFAULT_MESSAGE")
    ...
    @Deprecated(since = "4.0.0-RC3", forRemoval = true)
    @Removal("4.0.0-RC4")
    @Obsolete("com.bloogefest.common.StrictException.DEFAULT_CAUSE")
    ...
    @Deprecated(since = "4.0.0-RC3", forRemoval = true)
    @Removal("4.0.0-RC4")
    @Obsolete("com.bloogefest.common.StrictException.DEFAULT_SUPPRESSION")
    ...
    @Deprecated(since = "4.0.0-RC3", forRemoval = true)
    @Removal("4.0.0-RC4")
    @Obsolete("com.bloogefest.common.StrictException.DEFAULT_WRITABLE")
     ...
     */
    @Contract("_, _, _ -> new")
    public StrictException(final @NotNls @Nullable String message, final boolean suppression, final boolean writable) {
