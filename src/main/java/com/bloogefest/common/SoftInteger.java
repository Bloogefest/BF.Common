...
public interface SoftInteger extends SoftNumber<Integer> {
    ...
    /**
     * Выполняет запаковку объекта родной обёртки примитива 32-х битного целочисленного типа.
     *
     * @param value объект примитива 32-х битного целочисленного типа.
     *
    ...
    /**
     * Выполняет запаковку объекта примитива 32-х битного целочисленного типа.
     *
     * @param value объект примитива 32-х битного целочисленного типа.
     *
     * @return Экземпляр мягкой обёртки примитива 32-х битного целочисленного типа.
    ...
    /**
     * Класс мягкой обёртки примитива 32-х битного целочисленного типа по умолчанию.
     *
     * @since 3.0
     */
    class Default implements SoftInteger {
        ...
        /**
         * Инициализирует объект с переопределённым объектом примитива 32-х битного целочисленного типа.
         *
         * @param value объект примитива 32-х битного целочисленного типа.
         *
         * @since 3.0
