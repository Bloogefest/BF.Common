...
/**
 * Мягкое исключение, предназначенное для применения в некритических ситуациях, не требующих немедленного реагирования.
 * Например, когда происходит передача некорректного параметра. Это исключение расширяет
 * {@linkplain RuntimeException исключение во время выполнения}.
 *
 * @since 3.0.0-RC1
 */
