...
public class NotNullException extends ValidationException {
     ...
     * @since 1.0.0
     */
    public static final @NotNls @NotNull String defaultMessage = "The object must be null";
     ...
     * @since 2.0.0
     */
    public static final @NotNls @NotNull String templateMessage = "The %s must be null";
     ...
     */
    @Contract
    protected NotNullException(final @NotNls @Nullable String message, final @Nullable Throwable cause,
