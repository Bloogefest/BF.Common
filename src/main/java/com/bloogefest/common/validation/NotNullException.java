...
/**
 * Исключение валидации ненулевого экземпляра класса — это исключение, которое возникает при попытке валидации
 * ненулевого экземпляра класса.
 *
 * @since 1.0.0
 */
public class NotNullException extends ValidationException {
     ...
     * @since 4.0.0-RC3
     */
    public static final @NonNull String DEFAULT_MESSAGE = "The instance of the class must be null";
