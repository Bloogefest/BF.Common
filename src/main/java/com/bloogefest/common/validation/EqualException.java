...
public class EqualException extends ValidationException {
     ...
     * @since 1.0.0
     */
    public static final @NotNls @NotNull String defaultMessage = "The primary object must not be equal to the secondary object";
     ...
     * @since 2.0.0
     */
    public static final @NotNls @NotNull String templateMessage = "The %s must not be equal to the %s";
     ...
     */
    @Contract
    protected EqualException(final @NotNls @Nullable String message, final @Nullable Throwable cause,
