...
/**
 * Класс исключения валидации равенства первичного и вторичного экземпляра.
 *
 * @since 1.0
 */
public class NotEqualException extends ValidationException {
     ...
     * @since 1.0
     */
    protected static final @NonNls @NotNull String defaultMessage = "The primary instance must be equal to the secondary instance";
     ...
     * @since 2.0
     */
    protected static final @NonNls @NotNull String templateMessage = "The %s must be equal to the %s";
