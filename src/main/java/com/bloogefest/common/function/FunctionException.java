...
public class FunctionException extends SoftException {
     ...
     * @since 3.0.0
     */
    public static final @NotNls @NotNull String defaultMessage = "The function could not be executed";
     ...
     * @since 3.0.0
     */
    public static final @NotNls @NotNull String templateMessage = "The %s could not be executed";
     ...
     */
    @Contract
    protected FunctionException(final @NotNls @Nullable String message, final @Nullable Throwable cause,
