...
public class ComputeException extends FunctionException {
     ...
     * @since 4.0.0-RC3
     */
    public static final @NotNls @NotNull String DEFAULT_MESSAGE = "Failed to compute the function";
     ...
     * @since 4.0.0-RC3
     */
    public static final @NotNls @NotNull String TEMPLATE_MESSAGE = "Failed to compute %s";
     ...
     */
    @Contract("_ -> new")
    public ComputeException(final @NotNls @Nullable String message) {
     ...
     */
    @Contract("_, _ -> new")
    public ComputeException(final @NotNls @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract("_, _, _ -> new")
    public ComputeException(final @NotNls @Nullable String message, final boolean suppression, final boolean writable) {
