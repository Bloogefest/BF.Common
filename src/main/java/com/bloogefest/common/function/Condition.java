...
public interface Condition {
     ...
     * проверяет результат вычисления этого логического выражения и, если он истинный, инициализирует исключение
     * вычисления функции с переопределённой причиной, полученным исключением либо ошибкой от поставщика, и бросает его,
     * в противном случае возвращает ложный результат этого логического выражения.
     *
     ...
     * проверяет результат вычисления этого логического выражения и, если он ложный, вызывает функцию обратного вызова,
