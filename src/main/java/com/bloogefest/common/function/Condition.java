...
public interface Condition {
     ...
     * @throws ComputeException исключение вычисления функции, инициализируемое и бросаемое при истинности результата
     ...
     *
     * @throws NullException исключение валидации нулевого поставщика.
     * @throws ComputeException исключение вычисления функции, инициализируемое и бросаемое при ложности результата
     * вычисления этого логического выражения.
     * @since 3.1
     */
    @Contract(value = "_ -> new", pure = true)
