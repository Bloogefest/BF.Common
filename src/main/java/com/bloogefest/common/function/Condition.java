...
public interface Condition {
    ...
    /**
     * Проверяет логическую функцию и, если та ненулевая, возвращает её, в противном случае инициализирует и бросает
     * исключение валидации нулевого объекта (логической функции) с переопределённым сообщением (отформатированным
     * именем логической функции шаблонным сообщением).
     *
     * @param condition логическая функция.
     *
     * @return Переданная логическая функция.
     *
     * @throws NullException исключение валидации нулевого объекта (логической функции).
    ...
    /**
     * Инициализирует и возвращает логическое выражение, метод вычисления которого вызывает метод вычисления этого
     * логического выражения, а после инвертирует и возвращает результат вычисления этого логического выражения.
     *
     * @return Новое логическое выражение, метод вычисления которого вызывает метод вычисления этого логического
     * выражения, а после инвертирует и возвращает результат вычисления этого логического выражения.
     *
     * @since 1.0.0
     */
     ...
     * метод вычисления этого логического выражения и, если результат его вычисления истинный, вызывает метод вычисления
     * переданного в этот метод логического выражения, а после возвращает результат его вычисления, в противном случае
     * возвращает ложный результат вычисления.
     *
     * @param condition логическое выражение.
     *
     * @return Новое логическое выражение, метод вычисления которого вызывает метод вычисления этого логического
     * выражения и, если результат его вычисления истинный, вызывает метод вычисления переданного в этот метод
     * логического выражения, а после возвращает результат его вычисления, в противном случае возвращает ложный
