...
public interface Condition {
     ...
     * этот метод логической функции, а после возвращает её результат вычисления.
     *
     * @param condition логическая функция.
     *
     * @return Новая логическая функция, метод вычисления которой вызывает метод вычисления этой логической функции и,
     ...
     * которой вызывает метод вычисления этой логической функции и, если результат её вычисления истинный,
     ...
     *
     * @return Новая логическая функция, метод вычисления которой вызывает метод вычисления этой логической функции и,
     * если результат её вычисления истинный, инициализирует и бросает исключение вычисления функции (этой логической
