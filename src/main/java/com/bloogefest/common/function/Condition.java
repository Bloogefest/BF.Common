...
public interface Condition {
     ...
     * вычисления этого логического выражения.
     *
     ...
     * переопределённым сообщением, отформатированным именем поставщика шаблонным сообщением, в противном случае
     * инициализирует логическое выражение, метод вычисления которого проверяет результат вычисления этого логического
     * выражения и, если он ложный, инициализирует исключение вычисления функции с переопределённой причиной, полученным
     * исключением либо ошибкой от поставщика, и бросает его, в противном случае возвращает истинный результат
