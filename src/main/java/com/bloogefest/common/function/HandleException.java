...
public class HandleException extends FunctionException {
     ...
     * @since 4.0.0-RC3
     */
    public static final @NotNls @NotNull String DEFAULT_MESSAGE = "Failed to handle the object";
     ...
     * @since 4.0.0-RC3
     */
    public static final @NotNls @NotNull String TEMPLATE_MESSAGE = "Failed to handle %s";
     ...
     */
    @Contract("_ -> new")
    public HandleException(final @NotNls @Nullable String message) {
     ...
     */
    @Contract("_, _ -> new")
    public HandleException(final @NotNls @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract("_, _, _ -> new")
    public HandleException(final @NotNls @Nullable String message, final boolean suppression, final boolean writable) {
