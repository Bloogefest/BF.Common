...
public interface TriOptional<T1, T2, T3> {
    ...
    /**
     * Проверяет обёртку (обёртку трёх обнуляемых объектов), и если она ненулевая, то возвращает её, в противном случае
     * создаёт и возвращает встроенную реализацию на основе объектов (нулевых объектов).
     *
    ...
    /**
     * Проверяет объект (первичный объект) с помощью метода {@linkplain Validator#notNull(Object, String)} и возвращает
     * его.
     *
    ...
    /**
     * Проверяет объект (вторичный объект) с помощью метода {@linkplain Validator#notNull(Object, String)} и возвращает
     * его.
     *
    ...
    /**
     * Проверяет объект (третичный объект) с помощью метода {@linkplain Validator#notNull(Object, String)} и возвращает
     * его.
     *
    ...
    /**
     * Оборачивает объект (первичный объект) с помощью метода {@linkplain Optional#nullable(Object)} и возвращает
    ...
    /**
     * Оборачивает объект (вторичный объект) с помощью метода {@linkplain Optional#nullable(Object)} и возвращает
    ...
    /**
     * Оборачивает объект (третичный объект) с помощью метода {@linkplain Optional#nullable(Object)} и возвращает
    ...
    final class Suppliers<T1, T2, T3> implements TriOptional<T1, T2, T3> {
        ...
        /**
         * Проверяет объект (первичный объект) с помощью метода {@linkplain Validator#notNull(Object, String)} и
         * возвращает его.
         *
         * @return Ненулевой объект (первичный объект).
         *
        ...
        /**
         * Проверяет объект (вторичный объект) с помощью метода {@linkplain Validator#notNull(Object, String)} и
         * возвращает его.
         *
         * @return Ненулевой объект (вторичный объект).
         *
        ...
        /**
         * Проверяет объект (третичный объект) с помощью метода {@linkplain Validator#notNull(Object, String)} и
         * возвращает его.
         *
         * @return Ненулевой объект (третичный объект).
         *
