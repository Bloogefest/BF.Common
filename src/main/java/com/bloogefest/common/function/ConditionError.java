...
/**
 * Ошибка выполнения функции алгебры логики. Возникает при неудачной попытке выполнения функции алгебры логики.
 *
 * @since 4.0.0-RC3
 */
public class ConditionError extends FunctionError {
     ...
     */
    @Contract(value = "? -> new", impact = Contract.Impact.INTERNAL)
    public ConditionError(final @Nullable String message) {
        super(message);
    }
     ...
     */
    @Contract(value = "? -> new", impact = Contract.Impact.INTERNAL)
    public ConditionError(final @Nullable Throwable cause) {
     ...
     */
    @Contract(value = "?, ? -> new", impact = Contract.Impact.INTERNAL)
    public ConditionError(final @Nullable String message, final @Nullable Throwable cause) {
        super(message, cause);
    }
     ...
     */
    @Contract(value = "?, ? -> new", impact = Contract.Impact.INTERNAL)
    public ConditionError(final boolean suppression, final boolean writable) {
     ...
     */
    @Contract(value = "?, ?, ? -> new", impact = Contract.Impact.INTERNAL)
    public ConditionError(final @Nullable String message, final boolean suppression, final boolean writable) {
     ...
     */
    @Contract(value = "?, ?, ? -> new", impact = Contract.Impact.INTERNAL)
    public ConditionError(final @Nullable Throwable cause, final boolean suppression, final boolean writable) {
     ...
     */
    @Contract(value = "?, ?, ?, ? -> new", impact = Contract.Impact.INTERNAL)
    public ConditionError(final @Nullable String message, final @Nullable Throwable cause, final boolean suppression,
