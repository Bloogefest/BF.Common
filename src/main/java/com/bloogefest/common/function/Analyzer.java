...
/**
 * Функциональный интерфейс анализатора объектов.
 *
...
public interface Analyzer<T> {
     ...
     * объект, в противном случае инициализирует и бросает исключение.
     *
     ...
     *
     * @throws NullException исключение валидации нулевого анализатора либо нулевого анализируемого объекта.
     * @since 3.0
     */
    ...
    /**
     * Проверяет анализатор и, если он ненулевой, возвращает его, в противном случае инициализирует и возвращает другой
     * анализатор без логики.
     *
     * @param analyzer анализатор.
     *
