...
public interface Analyzer<T> {
     ...
     * экземпляр анализатора с логикой игнорирования и замены передаваемого ему экземпляра на переданный в этот метод анализируемый экземпляр, в противном случае
