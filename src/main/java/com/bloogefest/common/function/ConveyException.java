...
public class ConveyException extends FunctionException {
    ...
    /**
     * Создаёт исключение передачи объекта на основе переданного сообщения, {@linkplain #DEFAULT_CAUSE причины},
    ...
    /**
     * Создаёт исключение передачи объекта на основе {@linkplain #DEFAULT_MESSAGE сообщения по умолчанию}, переданной
    ...
    /**
     * Создаёт исключение передачи объекта на основе переданного сообщения и причины,
     * {@linkplain #DEFAULT_SUPPRESSION параметров подавления} и
     * {@linkplain #DEFAULT_WRITABLE трассировки стека по умолчанию}.
     *
     * @param message сообщение.
    ...
    /**
     * Создаёт исключение передачи объекта на основе {@linkplain #DEFAULT_MESSAGE сообщения} и
    ...
    /**
     * Создаёт исключение передачи объекта на основе переданного сообщения,
     * {@linkplain #DEFAULT_CAUSE причины по умолчанию}, переданных параметров подавления и трассировки стека.
     *
     * @param message сообщение.
     * @param suppression параметр подавления.
     ...
     */
    @Contract("_, _, _ -> new")
    public ConveyException(final @Nullable Throwable cause, final boolean suppression, final boolean writable) {
        this(DEFAULT_MESSAGE, cause, suppression, writable);
    }

    /**
     * Создаёт исключение передачи объекта на основе переданного сообщения, причины, параметров подавления и трассировки
     * стека.
     *
     * @param message сообщение.
     * @param cause причина.
