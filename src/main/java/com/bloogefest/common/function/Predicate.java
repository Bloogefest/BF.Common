...
public interface Predicate<T> {
    ...
    /**
     * Инициализирует и возвращает предикат, метод оценивания которого возвращает инвертированный результат оценивания
     * этого предиката. Инициализирует и возвращает предикат, метод оценивания которого вызывает метод оценивания этого
