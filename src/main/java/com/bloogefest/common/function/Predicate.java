...
public interface Predicate<T> {
    ...
    /**
     * Проверяет переданный предикат и, если тот ненулевой, возвращает его, в противном случае инициализирует и бросает
     * исключение валидации нулевого объекта (переданного предиката) с переопределённым сообщением (отформатированным
     * именем переданного предиката шаблонным сообщением).
     *
