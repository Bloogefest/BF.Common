...
public interface Predicate<T> {
    ...
    /**
     * Инициализирует и возвращает предикативную функцию, метод оценивания которой вызывает метод оценивания этой
     ...
     * функции, используя передаваемый в него оцениваемый объект, а после инвертирует и возвращает её результат
     * оценивания.
     *
     * @since 1.0.0
     */
