...
public interface Predicate<T> {
     ...
     * последовательно соединяет метод оценивания этого и вторичного анализатора конъюнкцией, используя конструкцию
    ...
    /**
     * Проверяет вторичный предикат и, если он ненулевой, инициализирует другой предикат, метод оценивания которого
     * последовательно соединяет метод оценивания этого и вторичного анализатора строгой дизъюнкцией, используя
    ...
    /**
     * Проверяет вторичный предикат и, если он ненулевой, инициализирует другой предикат, метод оценивания которого
     * последовательно соединяет метод оценивания этого и вторичного анализатора мягкой дизъюнкцией, используя
     * конструкцию try-finally, в противном случае инициализирует и бросает исключение.
     *
     * @param predicate вторичный предикат.
     *
