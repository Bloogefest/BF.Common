...
public interface Predicate<T> {
    ...
    /**
     * Проверяет предикат и, если тот ненулевой, возвращает его, в противном случае инициализирует и бросает исключение
     * валидации нулевого объекта (предиката) с переопределённым сообщением (отформатированным именем предиката
    ...
    /**
     * Оценивает объект, инициализирует и возвращает результат оценивания.
     *
     * @param object объект.
     *
    ...
    /**
     * Инициализирует предикат, метод оценивания которого возвращает инвертированный результат оценивания этого
     * предиката.
     *
     ...
     * соединяет метод оценивания этого и вторичного предиката конъюнкцией.
     *
     ...
     * (вторичного предиката) с переопределённым сообщением (отформатированным именем вторичного предиката шаблонным
     * сообщением), в противном случае инициализирует другой предикат, метод оценивания которого последовательно
     * соединяет метод оценивания этого и вторичного предиката строгой дизъюнкцией.
     *
     * @param predicate вторичный предикат.
     *
