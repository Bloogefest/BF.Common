...
public interface Predicate<T> {
     ...
     * валидации нулевого объекта (предиката).
     *
     ...
     * (вторичного предиката), в противном случае инициализирует другой предикат, метод оценивания которого
     * последовательно соединяет метод оценивания этого и вторичного предиката конъюнкцией.
     *
     ...
     * Проверяет вторичный предикат и, если тот нулевой, инициализирует и бросает исключение валидации нулевого объекта
     * (вторичного предиката), в противном случае инициализирует другой предикат, метод оценивания которого
     * последовательно соединяет метод оценивания этого и вторичного предиката строгой дизъюнкцией.
     *
     * @param predicate вторичный предикат.
     *
