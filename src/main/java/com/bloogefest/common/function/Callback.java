...
public interface Callback {
     ...
     * вызова, метод вызова которой последовательно вызывает метод вызова этой и переданной функции обратного вызова, в
     * противном случае инициализирует и бросает исключение валидации нулевого объекта (функции обратного вызова).
     *
     * @param callback функция обратного вызова.
     *
     * @return Новая функция обратного вызова, метод вызова которой последовательно вызывает метод вызова этой и
     * переданной функции обратного вызова.
     *
     * @throws NullException исключение валидации нулевого объекта (функции обратного вызова).
     * @since 2.0.0
     */
