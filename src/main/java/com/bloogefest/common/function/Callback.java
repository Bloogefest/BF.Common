...
public interface Callback {
    ...
    /**
     * Проверяет переданную функцию обратного вызова и, если та ненулевая, возвращает её, в противном случае
     * инициализирует и бросает исключение валидации нулевого объекта (переданной функции обратного вызова) с
     * переопределённым сообщением (отформатированным именем переданной функции обратного вызова шаблонным сообщением).
     *
     ...
     * метод инициализации функции обратного вызова, метод вызова которой ничего не делает, и возвращает результат её
     * инициализации.
     *
     * @param callback функция обратного вызова.
     *
    ...
    /**
     * Проверяет функцию обратного вызова и, если та ненулевая, инициализирует и возвращает другую функцию обратного
     * вызова, метод вызова которой последовательно вызывает метод вызова этой и переданной в этот метод функции
     * обратного вызова, в противном случае инициализирует и бросает исключение валидации нулевого объекта (функции
     * обратного вызова) с переопределённым сообщением (отформатированным именем функции обратного вызова шаблонным
     * сообщением).
     *
     * @param callback функция обратного вызова.
     *
     * @return Новая функция обратного вызова, метод вызова которой последовательно вызывает метод вызова этой и
     * переданной в этот метод функции обратного вызова.
     *
