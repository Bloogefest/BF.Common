...
public interface Callback {
    ...
    /**
     * Инициализирует и возвращает функцию обратного вызова, метод вызова которой не содержит логику.
     *
     ...
     * бросает исключение валидации нулевого объекта (функции обратного вызова) с переопределённым сообщением
     * (отформатированным именем функции обратного вызова шаблонным сообщением).
     *
