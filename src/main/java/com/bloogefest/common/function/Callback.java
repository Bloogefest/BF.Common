...
public interface Callback {
     ...
     * метод инициализации функции обратного вызова, метод вызова которой ничего не делает, а после возвращает результат
     * её инициализации.
     *
     * @param callback функция обратного вызова.
     *
     ...
     * после вызывает метод вызова переданной в этот метод функции обратного вызова.
     *
     * @param callback функция обратного вызова.
     *
