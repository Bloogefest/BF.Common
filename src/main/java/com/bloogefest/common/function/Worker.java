...
public interface Worker<TYPE> {
    ...
    /**
     * Подтверждает ненулевое явление переданного экземпляра обработчика типизированного экземпляра. Комбинирует данный
     * экземпляр обработчика типизированного экземпляра с переданным, гарантируя последовательное выполнение обработки
     * типизированного экземпляра каждым экземпляром.
     *
     * @param worker экземпляр обработчика типизированного экземпляра.
     *
