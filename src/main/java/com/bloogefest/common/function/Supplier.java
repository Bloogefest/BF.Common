...
public interface Supplier<T> {
     ...
     * поставки которого всегда поставляет переданный в этот метод поставляемый объект, в противном случае
     * инициализирует и бросает исключение валидации нулевого объекта (переданного поставляемого объекта) с
     * переопределённым сообщением (отформатированным именем переданного поставляемого объекта шаблонным сообщением).
     *
