...
public interface Supplier<T> {
     ...
     * которого всегда возвращает переданный в этот метод поставляемый объект, в противном случае инициализирует и
     * бросает исключение валидации нулевого объекта (поставляемого объекта).
     *
     * @param object поставляемый объект.
     *
     * @return Новый поставщик, метод поставки которого всегда возвращает переданный в этот метод поставляемый объект.
     *
     ...
     * валидации нулевого объекта (поставщика).
     *
