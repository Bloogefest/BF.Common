...
/**
 * Ошибка выполнения функции обратного вызова. Возникает при неудачной попытке выполнения функции обратного вызова.
 *
 * @since 4.0.0-RC3
 */
public class CallbackError extends FunctionError {
     ...
     */
    @Contract(value = "? -> new", impact = Contract.Impact.INTERNAL)
    public CallbackError(final @Nullable String message) {
        super(message);
    }
     ...
     */
    @Contract(value = "? -> new", impact = Contract.Impact.INTERNAL)
    public CallbackError(final @Nullable Throwable cause) {
     ...
     */
    @Contract(value = "?, ? -> new", impact = Contract.Impact.INTERNAL)
    public CallbackError(final @Nullable String message, final @Nullable Throwable cause) {
        super(message, cause);
    }
     ...
     */
    @Contract(value = "?, ? -> new", impact = Contract.Impact.INTERNAL)
    public CallbackError(final boolean suppression, final boolean writable) {
     ...
     */
    @Contract(value = "?, ?, ? -> new", impact = Contract.Impact.INTERNAL)
    public CallbackError(final @Nullable String message, final boolean suppression, final boolean writable) {
     ...
     */
    @Contract(value = "?, ?, ? -> new", impact = Contract.Impact.INTERNAL)
    public CallbackError(final @Nullable Throwable cause, final boolean suppression, final boolean writable) {
     ...
     */
    @Contract(value = "?, ?, ?, ? -> new", impact = Contract.Impact.INTERNAL)
    public CallbackError(final @Nullable String message, final @Nullable Throwable cause, final boolean suppression,
