...
public interface Processor<TYPE, RESULT> {
    ...
    /**
     * Подтверждает ненулевое явление переданного вычисляемого типизированного экземпляра.
     * Производит константный экземпляр процессора типизированного экземпляра.
     *
     ...
     *
     * @throws NullException невозможность подтверждения ненулевого явления переданного вычисляемого типизированного экземпляра.
     * @author Bloogefest
     * @since 0.2.0
     */
    @ApiStatus.AvailableSince("0.2.0")
    @Contract(value = "_ -> new", pure = true)
    static <TYPE, RESULT> @NotNull Processor<TYPE, RESULT> constant(final @NotNull RESULT instance) throws NullException {
     ...
     *
     * @throws NullException невозможность подтверждения ненулевого явления экземпляра процессора типизированного экземпляра.
     * @author Bloogefest
     * @since 0.2.0
     */
    @ApiStatus.AvailableSince("0.2.0")
    @Contract(value = "_ -> param1", pure = true)
    static <TYPE, RESULT> @NotNull Processor<TYPE, RESULT> of(final @NotNull Processor<TYPE, RESULT> processor) throws NullException {
     ...
     *
     * @throws ProcessorException невозможность выполнения обработки переданного типизированного экземпляра и вычисления типизированного экземпляра.
     * @author Bloogefest
     * @since 0.2.0
     */
    @ApiStatus.AvailableSince("0.2.0")
    ...
    /**
     * Подтверждает ненулевое явление переданного экземпляра процессора типизированного экземпляра.
     * Комбинирует данный экземпляр процессора типизированного экземпляра с переданным.
     *
     ...
     *
     * @throws NullException невозможность подтверждения ненулевого явления переданного экземпляра процессора типизированного экземпляра.
     * @author Bloogefest
     * @since 0.2.0
     */
    @ApiStatus.AvailableSince("0.2.0")
    @Contract(value = "_ -> new", pure = true)
    default <RESULT_> @NotNull Processor<TYPE, RESULT_> with(final @NotNull Processor<? super RESULT, ? extends RESULT_> processor) throws NullException {
